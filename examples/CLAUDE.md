...
1. **MANDATORY**: Complete all lolek-mcp server tool runs (get-introduction, get-tools, get-development-guide-index, get-agent-rules)
2. **MANDATORY**: Read and understand DATABASE.md completely (use development guide tools if needed)
3. **MANDATORY**: Use `get-development-guide-section` to find relevant component patterns for your task
4. **MANDATORY**: Verify all structural decisions align with database schema AND development guide examples
5. **MANDATORY**: Check existing code patterns from development guide AND database interactions
6. **MANDATORY**: Validate all assumptions against actual database structure AND development guide guidance
7. **MANDATORY**: Test every change including database operations using patterns from development guide
8. **MANDATORY**: Ensure UI components reflect database relationships AND match development guide examples
9. **MANDATORY**: Follow established data access patterns from development guide workflows
10. **MANDATORY**: Never proceed without explicit development guide guidance for the task
...
### YOU MUST ALWAYS:
- ✅ Run mandatory development guide tools FIRST (get-introduction, get-tools, get-development-guide-index, get-agent-rules)
